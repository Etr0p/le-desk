...
describe('module 3 — cibles de la spec (avec préférences utilisateur)', () => {
  const m = getModule('03-actions-indices')!;
  ...
  it('est complet', () => {
    ...
    expect(m.formules.length).toBeGreaterThanOrEqual(14);
  });
