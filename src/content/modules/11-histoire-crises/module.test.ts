...
describe('module 11 — cibles de la spec (module culture, avec préférences utilisateur)', () => {
  const m = getModule('11-histoire-crises')!;
  ...
  it('est complet', () => {
    ...
    expect(m.formules.length).toBeGreaterThanOrEqual(13);
  });
