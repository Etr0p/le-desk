    ...
    <>
      ...
      <div className="flex flex-col gap-4">
        <Card titre="Apparence">
          <p className="mb-3 text-sm text-text-muted">Thème de l'interface</p>
          <div role="radiogroup" aria-label="Thème de l'interface" className="inline-flex rounded-md border border-border bg-surface-2 p-0.5">
            {THEMES.map(t => {
        ...
        <Card titre="À venir">
          <p className="text-sm leading-relaxed text-text-muted">
            Nombre de nouvelles cartes par jour, export et import de la sauvegarde locale, remise à zéro.
          </p>
        </Card>
      </div>
    </>
